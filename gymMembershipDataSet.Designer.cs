...
namespace Gym_Membership_Manage.gymMembershipDataSetTableAdapters {
...
SELECT ID, Name, Number, Duration, Occupation FROM Memberships WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Gym_Membership_Manage.Properties.Settings.Default.gymMembershipConnectionString;
        }
